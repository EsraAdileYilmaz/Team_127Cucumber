Feature:  US1011 scenario'da verilen yanlis bilgilerle negatif login testi
  ...
  Scenario Outline: TC17 liste olarak verilen yanlis kullanici bilgileri ile giris yapilamamali
    ...
    # Bu Featuredaki verilenEmail  ve verilen Password lari direk bu Feature'den aldi.
    #yani configuration.properties'den okumadan degerleri sayfa icinden aliyor
    #bunun icin bir onceki UserStoryden farkli olmasi icin steplerde yazilani guncelliyoruz
    #boylece 2 farkli method olusturmus oluyoruz.bunlarin steplerini bir onceki US'den farklilastirdik